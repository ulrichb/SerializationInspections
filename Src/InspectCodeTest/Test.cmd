...
%RsatPath%\InspectCode.exe --caches-home:_ReSharperInspectCodeCache --toolset=14.0 -o:Inspections.xml ..\SerializationInspections.Plugin.Tests\test\data\SerializationInspections.Sample.sln || EXIT /B 1
